...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: "Build A Ring Farm Wiki - Codes, Seeds & Guide",
    description:
      "Build A Ring Farm Wiki with codes, seed packs, upgrades, farm expansion, mutations, money tips, and offline income guides.",
    robots: {
      index: true,
      follow: true,
      googleBot: {
      ...
      images: [
        {
          ...
          width: 1920,
          height: 1080,
          alt: "Build A Ring Farm gameplay cover",
        },
      ],
    },
    twitter: {
