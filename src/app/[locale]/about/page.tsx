...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const siteUrl = process.env.NEXT_PUBLIC_SITE_URL || 'https://buildaringfarm.online'
  const path = '/about'
  ...
  return {
    ...
    openGraph: {
      ...
      siteName: 'Build A Ring Farm Wiki',
      title: 'About Build A Ring Farm Wiki',
      description: 'Learn about our mission to provide the best Build A Ring Farm game resources and guides.',
      images: [
        {
          url: `${siteUrl}/og-image.jpg`,
          width: 1200,
          height: 630,
          alt: 'Build A Ring Farm Wiki',
        },
      ],
    },
    twitter: {
      ...
      title: 'About Build A Ring Farm Wiki',
      description: 'Learn about our mission to provide the best Build A Ring Farm game resources.',
      ...
      <section className="relative py-20 px-4 border-b border-border">
        <div className="container mx-auto max-w-4xl text-center">
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">
            About Build A Ring Farm Wiki
          </h1>
          <p className="text-slate-300 text-lg mb-2">
            Your community-driven resource center for Build A Ring Farm
          </p>
        </div>
      </section>
        ...
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              ...
              Build A Ring Farm Wiki is here to support you every step of the way.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 px-4 bg-slate-900/30">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            <h2>Our Mission</h2>
            <p>
              Our mission is simple: <strong>to empower Build A Ring Farm players with accurate, up-to-date information
            ...
            <h2>Our Vision</h2>
            <p>
              We envision Build A Ring Farm Wiki as the <strong>go-to destination</strong> for every Build A Ring Farm player seeking
      ...
      <section className="py-12 px-4 bg-slate-900/30">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              Build A Ring Farm Wiki is built <strong>by the community, for the community</strong>. We welcome contributions,
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              Build A Ring Farm Wiki is maintained by a dedicated team of passionate gamers and developers who love
              Build A Ring Farm as much as you do. We're players first, constantly testing strategies, exploring game
            ...
            <ul>
              <li><strong>Game analysis:</strong> Deep understanding of Build A Ring Farm mechanics and strategies</li>
        ...
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p className="text-yellow-400/90">
              <strong>Build A Ring Farm Wiki is an unofficial fan-made website.</strong> We are NOT affiliated with,
              endorsed by, or associated with the developers of Build A Ring Farm or any official entities.
            </p>
            <p>
            ...
            <p>
              Build A Ring Farm Wiki is a non-profit, community resource created by fans, for fans.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <div className="not-prose grid md:grid-cols-2 gap-4 my-6">
              <div className="p-4 rounded-lg bg-slate-900/50 border border-slate-800">
                ...
                <a href="mailto:contact@buildaringfarm.online" className="text-[hsl(var(--nav-theme-light))] hover:underline">
                  contact@buildaringfarm.online
                </a>
              </div>
              <div className="p-4 rounded-lg bg-slate-900/50 border border-slate-800">
                <h3 className="text-lg font-semibold text-white mb-2">Bug Reports</h3>
                <a href="mailto:support@buildaringfarm.online" className="text-[hsl(var(--nav-theme-light))] hover:underline">
                  support@buildaringfarm.online
                </a>
              </div>
              <div className="p-4 rounded-lg bg-slate-900/50 border border-slate-800">
                <h3 className="text-lg font-semibold text-white mb-2">Content Submissions</h3>
                <a href="mailto:contribute@buildaringfarm.online" className="text-[hsl(var(--nav-theme-light))] hover:underline">
                  contribute@buildaringfarm.online
                </a>
              </div>
              <div className="p-4 rounded-lg bg-slate-900/50 border border-slate-800">
                <h3 className="text-lg font-semibold text-white mb-2">Partnerships</h3>
                <a href="mailto:partnerships@buildaringfarm.online" className="text-[hsl(var(--nav-theme-light))] hover:underline">
                  partnerships@buildaringfarm.online
                </a>
              </div>
            </div>
      ...
      <section className="py-12 px-4 bg-gradient-to-r from-purple-900/30 to-blue-900/30 border-y border-border">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-slate-300 mb-6 max-w-2xl mx-auto">
            Stay updated with the latest guides, tips, and Build A Ring Farm news.
