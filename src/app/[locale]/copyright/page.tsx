...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Copyright Notice - Build A Ring Farm Wiki',
    description: 'Copyright and intellectual property information for Build A Ring Farm Wiki. Learn about content ownership, fair use, DMCA policy, and how to report copyright infringement.',
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      title: 'Copyright Notice - Build A Ring Farm Wiki',
      description: 'Copyright and intellectual property information for Build A Ring Farm Wiki.',
      images: [
        {
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              © 2025-2026 Build A Ring Farm Wiki. All rights reserved.
            </p>
            <p>
              Unless otherwise noted, all original content on this website, including but not limited to text,
              graphics, logos, guides, articles, and compilations, is the property of Build A Ring Farm Wiki and is
              protected by international copyright laws.
            </p>

            <h3>1.2 Game Assets and Trademarks</h3>
            <p>
              Build A Ring Farm Wiki is an <strong>unofficial fan-made website</strong> and is NOT affiliated with,
            ...
            <p>
              ...
              affiliation with Build A Ring Farm Wiki.
            </p>
            ...
            <p>
              ...
              Build A Ring Farm Wiki<br />
              Email: <a href="mailto:dmca@buildaringfarm.online" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@buildaringfarm.online</a>
            </p>
            <p>
            ...
            <ul>
              <li>Provide clear attribution to "Build A Ring Farm Wiki"</li>
              <li>Include a link back to the original page (if digital)</li>
              <li>Do not imply endorsement or affiliation</li>
            </ul>
            <p>
              Example attribution: <em>"Source: Build A Ring Farm Wiki (buildaringfarm.online)"</em>
            </p>
            ...
            <p>
              <strong>General Inquiries:</strong> <a href="mailto:copyright@buildaringfarm.online" className="text-[hsl(var(--nav-theme-light))] hover:underline">copyright@buildaringfarm.online</a><br />
              <strong>DMCA Notices:</strong> <a href="mailto:dmca@buildaringfarm.online" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@buildaringfarm.online</a>
            </p>
            <p>
